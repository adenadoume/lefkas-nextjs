      ...
      <div className="mb-6">
        ...
        <Tabs value={selectedMonth} onValueChange={setSelectedMonth}>
          <div className="overflow-x-auto pb-2">
            <TabsList className="flex gap-2 mb-4 min-w-max">
              {months.map(month => (
                <TabsTrigger 
                  key={month} 
                  value={month} 
                  className="px-3 py-2 text-sm font-medium text-gray-600 bg-gray-100 rounded-lg hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 whitespace-nowrap"
                >
                  {month}
                </TabsTrigger>
              ))}
